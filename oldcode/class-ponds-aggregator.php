...
if ( ! class_exists( 'Ponds_Aggregator' ) ) {

	class Ponds_Aggregator {
		 ...
		 * @since    1.0.0
		 */
		const PLUGIN_ID 		= 'ponds-aggregator';
		 ...
		 * @since    1.0.0
		 */
		const PLUGIN_NAME 		= 'Ponds Aggregator';
		 ...
		 * @since    1.0.0
		 */
		const CLASS_PREFIX 		= 'Ponds_Aggregator_';
		 ...
		 * @since    1.0.0
		 */
		const PLUGIN_PREFIX 	= 'ponds-aggregator-';
		...
		public function __construct() {
			...
			self::$modules['Ponds_Aggregator_Loader']                    = Ponds_Aggregator_Loader::get_instance();
			self::$modules['Ponds_Aggregator_Controller_Public']         = Ponds_Aggregator_Controller_Public::get_instance();
			self::$modules['Ponds_Aggregator_Controller_Admin_Settings'] = Ponds_Aggregator_Controller_Admin_Settings::get_instance();
			self::$modules['Ponds_Aggregator_Controller_Admin_Notices']  = Ponds_Aggregator_Controller_Admin_Notices::get_instance();
