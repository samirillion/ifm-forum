...
class crowdsorterPostTemplate
{
  public static function render()
  {
    ...
    <form id="submit-post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
      ...
      <?php wp_editor('', 'new-post-text-content', array('editor_css' => '<style scoped>#wp-new-post-text-content-wrap { display: none; }</style>', 'textarea_name' => 'post-text-content', 'editor_height' => 200, 'teeny' => true)); ?>
