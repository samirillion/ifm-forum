...
<div class="ifm-account-details">
	...
	if (count_user_posts($user_id, IFM_POST_TYPE)) { ?>
		<a class='btn btn-default view-user-posts' href='<?php echo add_query_arg(' user_id', $user_id, home_url(IFM_ROUTE_FORUM)) ?>'><?php echo $current_user->user_nicename ?>'s posts</a>
	<?php
	}
